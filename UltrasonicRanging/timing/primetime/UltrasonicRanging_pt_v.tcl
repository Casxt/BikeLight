...
read_verilog  UltrasonicRanging.vo
current_design UltrasonicRanging
link
...
read_sdf UltrasonicRanging_v.sdo
...
set_load -pin_load 10 [get_ports { Distance[0] } ]
set_load -pin_load 10 [get_ports { Distance[1] } ]
set_load -pin_load 10 [get_ports { Distance[2] } ]
set_load -pin_load 10 [get_ports { Distance[3] } ]
set_load -pin_load 10 [get_ports { Distance[4] } ]
set_load -pin_load 10 [get_ports { Distance[5] } ]
set_load -pin_load 10 [get_ports { Distance[6] } ]
set_load -pin_load 10 [get_ports { Distance[7] } ]
set_load -pin_load 10 [get_ports { Distance[8] } ]
set_load -pin_load 10 [get_ports { Distance[9] } ]
