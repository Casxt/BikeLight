...
read_verilog  Sound.vo
current_design Sound
link
...
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { CTCclock } ] -name CTCclock  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Soundclock } ] -name Soundclock  
