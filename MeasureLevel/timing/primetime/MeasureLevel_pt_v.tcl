...
read_verilog  MeasureLevel.vo
current_design MeasureLevel
link
...
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Countclock } ] -name Countclock  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Level } ] -name Level  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
...
set_load -pin_load 10 [get_ports { output[0] } ]
set_load -pin_load 10 [get_ports { output[10] } ]
set_load -pin_load 10 [get_ports { output[11] } ]
set_load -pin_load 10 [get_ports { output[12] } ]
set_load -pin_load 10 [get_ports { output[13] } ]
set_load -pin_load 10 [get_ports { output[1] } ]
set_load -pin_load 10 [get_ports { output[2] } ]
set_load -pin_load 10 [get_ports { output[3] } ]
set_load -pin_load 10 [get_ports { output[4] } ]
set_load -pin_load 10 [get_ports { output[5] } ]
set_load -pin_load 10 [get_ports { output[6] } ]
set_load -pin_load 10 [get_ports { output[7] } ]
set_load -pin_load 10 [get_ports { output[8] } ]
set_load -pin_load 10 [get_ports { output[9] } ]
