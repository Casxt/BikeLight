...
read_verilog  TimeCount.vo
current_design TimeCount
link
...
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Freshclock } ] -name Freshclock  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Timeclock } ] -name Timeclock  
