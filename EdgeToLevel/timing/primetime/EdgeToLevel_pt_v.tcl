...
read_verilog  EdgeToLevel.vo
current_design EdgeToLevel
link
...
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Input } ] -name Input  
# WARNING:  The required clock period is not set. The default value (100 ns) is used. 
...
set_load -pin_load 10 [get_ports { Output } ]
