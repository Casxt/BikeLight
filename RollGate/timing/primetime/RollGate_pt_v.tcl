...
read_verilog  RollGate.vo
current_design RollGate
link
...
create_clock -period 100.000 -waveform {0.000 50.000} [get_ports { Rollclock } ] -name Rollclock  
